...
def testing(args: argparse.Namespace) -> None:
    ...
    if args.task_dataset == 'new_lv':
        ...
        bart_src_lang, bart_tgt_lang = 'lv_LV', 'lv_LV'
        ...
        bart_src_lang, bart_tgt_lang = 'et_EE', 'et_EE'
        ...
        bart_src_lang, bart_tgt_lang = 'fi_FI', 'fi_FI'
    ...
    args.bos_token_id = tokenizer.bos_token_id if tokenizer.bos_token_id is not None else tokenizer.cls_token_id
    ...
    for test_iter_idx, data_dicts in enumerate(tqdm(dataloader_test, total=len(dataloader_test), desc=f'Testing')):
        ...
        for each_pred_sentence, each_reference in zip(batch_pred_sentences, all_caption):
            ...
            if '</s>' in each_pred_sentence: # facebook/bart-base & vinai/bartpho-syllable & joelito/legal-latvian-roberta-base
            ...
            elif '[SEP]' in each_pred_sentence: # tartuNLP/EstBERT
                each_pred_sentence = each_pred_sentence[:each_pred_sentence.index('[SEP]')]
