...
class ArgParser():
    def __init__(self):
        ...
        job_list = ['preprocessing', 'training', 'resume_training', 'testing', # For captioning
                    'gpt_annotating', 'backtrans_annotating', 'valid_test_translation'] # For annotating
        ...
        annotation_mode_list = ['original_en', 'aihub_ko', 'gpt_en', 'gpt_ko', 'backtrans_en', 'backtrans_ko']
