...
class ArgParser():
    def __init__(self):
        ...
        job_list = ['preprocessing', 'training', 'resume_training', 'testing', 'gpt_annotating', 'backtrans_annotating', 'valid_test_translation']
        self.parser.add_argument('--job', type=str, choices=job_list, default='training',
                                 help='Job to do; Must be given.')
        dataset_list = ['flickr8k', 'flickr30k', 'coco2017']
        ...
        annotation_mode_list = ['original', 'gpt_en', 'gpt_ko', 'backtrans_en', 'backtrans_ko']
